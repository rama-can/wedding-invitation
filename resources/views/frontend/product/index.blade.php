<x-front-layout :title="$title">
    ...
    @endpush
    <div class="container">
        <h1 class="my-4">Semua Peralatan</h1>
        <div class="row">
            <!-- Example of a category section -->
            <div class="col-12">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('products.detail', ['category' => $product->category->slug, 'product' => $product->slug]) }}" class="btn btn-primary">Baca Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                    @empty
                        <h4 class="text-muted text-center">No equipment was found.</h4>
                    @endforelse
